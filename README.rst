...
C-Fabric plugin also support VLAN configuration for baremetal deploy.
The following configuration is necessary:

1. Configure ``network mode`` for VFAB.

   By default, all of VFAB is ``host mode``. Therefore, please change
...
.. NOTE::
  ...
  PLEASE DO NOT EDIT C-Fabric configuration directory when you will use this
  feature.

Supported C-Fabric firmware is V02.40 and later.
