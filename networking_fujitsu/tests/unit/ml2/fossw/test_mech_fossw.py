...
class TestFOSSWBaremetalPortsVlan(helper.FujitsuMechanismHelper):
...
class TestFOSSWBaremetalPortsVxlan(TestFOSSWBaremetalPortsVlan):
    ...
    def test_create_network(self):
        ...
        vni = utils.get_segmentation_id(ctx)
