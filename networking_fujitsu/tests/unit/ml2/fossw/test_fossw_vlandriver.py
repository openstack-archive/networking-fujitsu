...
class TestFOSSWVlanDriverCreateVlan(BaseTestFOSSWVlanDriver):
    ...
    def setUp(self):
        ...
        self.cli.connect = mock.Mock(return_value=None)
        self.cli.create_vlan = mock.Mock(return_value=None)
        self.cli.disconnect = mock.Mock(return_value=None)
...
class TestFOSSWVlanDriverDeleteVlan(BaseTestFOSSWVlanDriver):
    ...
    def setUp(self):
        ...
        self.cli.connect = mock.Mock(return_value=None)
        self.cli.delete_vlan = mock.Mock(return_value=None)
        self.cli.disconnect = mock.Mock(return_value=None)
...
class TestFOSSWVlanDriverSetupVlan(BaseTestFOSSWVlanDriver):
    ...
    def setUp(self):
        ...
        self.cli.connect = mock.Mock(return_value=None)
        self.cli.set_vlan = mock.Mock(return_value=None)
        self.cli.disconnect = mock.Mock(return_value=None)
...
class TestFOSSWVlanDriverSetupLAG(BaseTestFOSSWVlanDriver):
    ...
    def test_lag_normal(self):
        ...
        for lli in llis:
            self.cli.join_to_lag.assert_called_with(mock.ANY, '3/1')
...
class TestFOSSWVlanDriverClearVlan(BaseTestFOSSWVlanDriver):
    ...
    def setUp(self):
        ...
        self.cli = mock.Mock()
        self.cli.connect.return_value = None
        self.cli.clear_vlan.return_value = None
        self.cli.disconnect.return_value = None
