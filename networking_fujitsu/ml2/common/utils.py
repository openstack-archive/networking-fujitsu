...
def eliminate_val(source, reject):
    ...
    :return eliminated: a string separated with ","
    :rtype string
    """
    if source is None:
        return
...
def get_network_segments(network):
    ...
    :return network type: 'vlan' or 'vxlan'
    :rtype: string

    :return segmentation_id: VLANID or VNI
    :rtype: integer
    """
...
def get_physical_connectivity(port):
    ...
    :return lli: "local_link_information" as follows
                 ...
                 empty list
    :rtype: a list of dict or empty list
    """
...
def is_baremetal(port):
    ...
    :type port: a dictionary of neutron port

    :return: True(vnic_type is baremetal), False(otherwise)
    :rtype: boolean
    """
...
def is_lag(local_link_information):
    ...
    :type local_link_information: a list of dict

    :return: True(mode is LAG) False(otherwise)
    :rtype: boolean
    """
